...
?dbConnect
con = dbConnect(MySQL(), user = "root", password = "Anumsei123!", dbname = "titanicDB", host = "localhost")
...
?src_mysql
con2 <- src_mysql(dbname = "titanicdb", user = "root", password = "Anumsei123!", host = "localhost")
